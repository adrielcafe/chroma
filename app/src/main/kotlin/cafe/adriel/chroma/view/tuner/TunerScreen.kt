...
class TunerScreen(
    ...
    override fun Content() {
        ...
        ChromaTheme {
            BackdropScaffold(
                appBar = {
                    TunerTopBar(scope) {
                        scope.launch { scaffoldState.toggle() }
                    }
                },
                backLayerContent = {
                    ...
                    screenState.message?.let { message ->
                        MessageSnackbar(
                            ...
                            onDismissed = viewModel::consumeMessage
                        )
                    }
                },
                frontLayerContent = {
    ...
    @Composable
    private fun TunerTopBar(scope: CoroutineScope, onSettingsClicked: () -> Unit) =
        TopAppBar(
            title = {
                Image(
        ...
        ConstraintLayout(
            ...
            if (tuning.deviationResult is TuningDeviationResult.Detected &&
                ...
                TuningNote(
                    ...
                    basicMode = settings.advancedMode,
